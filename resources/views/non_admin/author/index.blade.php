                        ...
                        <table class="table table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$a->telp}}</td>
                                    <td>
                                        <a href="{{ route('non_admin.author.edit',$a->id) }}" class="btn btn-warning">Edit</a>
                                        <a href="{{ route('non_admin.author.hapus',$a->id) }}" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus author ini? Bila menghapus maka buku author ini juga akan terhapus.')">Hapus</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
...
<div class="modal fade" id="kelolaAuthor" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('non_admin.author.store') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title"><span>Tambah</span> Author</h5>
