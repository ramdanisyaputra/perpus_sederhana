...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Data Non Admin</div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive py-4">
                        <table class="table table-flush">
                            ...
                            <tbody>
                                @forelse($non_admin as $key => $a)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$a->nama}}</td>
                                    <td>{{$a->username}}</td>
                                    <td>
                                        <a href="{{ route('admin.non_admin.edit',$a->id) }}" class="btn btn-warning">Edit</a>
                                        <a href="{{ route('admin.non_admin.hapus',$a->id) }}" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?')">hapus</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
...
<div class="modal fade" id="kelolaNonAdmin" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.non_admin.store') }}" method="POST">
                @csrf
