                        ...
                        <table class="table table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.buku.edit',$a->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="{{ route('admin.buku.hapus',$a->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
