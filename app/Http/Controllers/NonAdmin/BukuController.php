...
class BukuController extends Controller
{
    public function index()
    {
        $buku = Buku::all();
        $author = Author::all();
        return view('non_admin.buku.index',compact('buku','author'));
    }
    ...
    public function edit($id)
    {
        $buku = Buku::find($id);
        $author = Author::all();
        return view('non_admin.buku.edit',compact('buku','author'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('non_admin/buku')->with('success','Buku berhasil dirubah');
    }

    public function hapus($id)
    {
        Buku::find($id)->delete();
        return redirect('non_admin/buku')->with('success','Buku berhasil dihapus');
    }
}
