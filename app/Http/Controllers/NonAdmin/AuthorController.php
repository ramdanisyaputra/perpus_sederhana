...
class AuthorController extends Controller
{
    ...
    {
        $author = Author::all();
        return view('non_admin.author.index',compact('author'));
    }
    
    public function edit($id)
    {
        $author = Author::find($id);
        return view('non_admin.author.edit',compact('author'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('non_admin/author')->with('success','Author berhasil dirubah');
    }
    ...
    public function hapus($id)
    {
        ...
        return redirect('non_admin/author')->with('success','Author berhasil dihapus');
